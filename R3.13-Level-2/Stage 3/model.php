...
$dataTshirt = [(new Tshirt("T-shirt Tri-Force"))->setDescription("60% cotton, 40% polyester. Laver à l'eau froide. Ne pas utiliser de javel")
        ->setSizes(["S", "M", "L", "XL"])->setPrice(29.9)->setImage("./asset/tshirt-triforce.png"),
        (new Tshirt("T-shirt Hyrule"))->setDescription("50% cotton, 50% polyester. Laver à 30° max")
        ->setSizes(["S", "M", "L", "XL"])->setPrice(24.9)->setImage("./asset/tshirt-hyrule.png"),
        (new Tshirt("T-shirt Sheik"))->setDescription("100% synthétique. Lavege à 40°. Ne pas utiliser de détachant")
        ->setSizes(["S", "M", "L", "XL"])->setPrice(24.9)->setImage("./asset/tshirt-sheika.jpg")
];
